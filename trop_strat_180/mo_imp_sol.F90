...
!PS
    ...
    integer :: nr_iter, &
         ...
         m
!PS
    integer :: number_p,omp_get_num_threads
...
!PS
!PS    do m = 1,max(1,rxntot)
!PS      write(iulog,'(A,I4,E16.4)') 'Checking reaction rate', m, reaction_rates(1,1,m)
!PS    end do
!PS    do m = 1,gas_pcnst
!PS      write(iulog,'(A,I4,E16.4)') 'Checking base value   ', m, base_sol(1,1,m)
!PS    end do
!PS    do m = 1,max(1,extcnt)
!PS      write(iulog,'(A,I4,E16.4)') 'Checking extfrc       ', m, extfrc(1,1,m)
!PS    end do
!PS    do m = 1,max(1,gas_pcnst)
!PS      write(iulog,'(A,I4,E16.4)') 'Checking het rates    ', m, het_rates(1,1,m)
!PS    end do
